  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement(StateDiagram, {states: this.state.states})
      )
    );
  }
...
},{"./state-diagram":3}],3:[function(require,module,exports){
var _ = require('lodash');

var StateNode = require('./state-node');

var StateDiagram = React.createClass({displayName: "StateDiagram",

  render: function() {
    var stateNodes = _.map(this.props.states, function(state) {
      return (
        React.createElement("div", {key: state.name}, 
          React.createElement(StateNode, {name: state.name, code: state.code}), 
...
},{"./state-node":4,"lodash":1}],4:[function(require,module,exports){
  ...
  render: function() {
    return (
      React.createElement("div", {className: "state-node"}, 
        ...
        React.createElement("div", {className: "code"}, this.props.code)
      )
    );
  }
...
},{"./components/app":2,"./config/config":5}]},{},[6]);
